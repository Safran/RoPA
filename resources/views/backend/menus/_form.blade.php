    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="container">
                ...
                {{ bs()->formGroup(bs()->text('slug', old('slug', isset($menu) ? $menu->slug : '')))
                 ->label(__('admin/menus.fields.slug.label'))
                 ->helpText(__('admin/menus.fields.slug.help'))
                 }}
                @include('partials.form.fields.translatableinputtext', [
                 'label' => __('admin/menus.fields.title.label'),
                 'name' => 'title',
                 'required' => true,
                 'model' => isset($menu) ? $menu : null,
             ])
            </div>
        </div>
    </div>
